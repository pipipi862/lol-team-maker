...
for (let i = 0; i < need; i++) {
  ...
  <li>希望レーンが1箇所の場合、原則としてそのレーンに優先配置されます</li>
  <li>希望レーンが1箇所のメンバーが3人以上の場合は、ランダムで2名を希望レーンに配置、残りのメンバーは他レーンに配置されます</li>
    <li>チーム分け後、手動でメンバーの入れ替えが可能です（スマホ不可）</li>
  <li>参加人数が10人未満の時はAIが補填されます</li>
